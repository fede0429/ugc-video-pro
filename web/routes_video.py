...
async def generate_video(
    ...
    model: str = Form(..., pattern="^(auto|veo_31_fast|veo_31_quality|seedance_15|seedance_2|sora_2|sora_2_pro|runway|kling_30|hailuo|veo_3|veo_3_pro|veo_31_pro)$"),
    ...
    quality_tier: str = Form(default="economy", pattern="^(economy|premium|china)$"),
