...
async function getLanding() {
  return apiFetch('/api/auth/landing');
}
...
async function getUserPermissions() {
  return apiFetch('/api/admin/user-permissions');
}

async function getUserPermissionProfile(userId) {
  return apiFetch(`/api/admin/user-permissions/${userId}`);
}

async function updateUserPermissions(userId, payload) {
  return apiFetch(`/api/admin/user-permissions/${userId}`, {
    method: 'PUT',
